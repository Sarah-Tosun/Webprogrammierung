...
function init(){
	...
	var playerList = document.getElementById("player1");
  	playerList.addEventListener("click", clickOnPlayer, false);
  	var playerList = document.getElementById("player2");
  	playerList.addEventListener("click", clickOnPlayer, false);
  	var playerList = document.getElementById("player3");
  	playerList.addEventListener("click", clickOnPlayer, false);
  	var playerList = document.getElementById("player4");
  	playerList.addEventListener("click", clickOnPlayer, false);
	//login
...
function clickOnPlayer (event) {
  	var element = event.currentTarget;
  	var tmp = element.innerText;
  	element.innerText = document.getElementById("player1").innerText;
  	document.getElementById("player1").innerText = tmp;
  	// alert(element);
}
function start(){
